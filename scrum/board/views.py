...
class UpdateHookMixin(object):
    ...
    def _build_hook_url(self, obj):
        ...
        return '{}://{}/{}/{}'.format(
            ...
            settings.WATERCOOLER_SEVER, model, obj.pk)
    ...
    def _send_hook_request(self, obj, method):
        ...
        except reqesut.exceptions.ConnectionError:
            # Host could no be resolved or the connection was refused
            pass
    ...
    def post_save(self, pbj, created=False):
